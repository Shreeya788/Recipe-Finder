  ...
  return (
    <div className="pt-8 mt-8 ">
      ...
      >
        ...
        >
          <div
            className={` text-black py-5 flex items-center justify-center ${props.padding}`}
          >
            <div className=" ">
              <p className={`font-sans font-semibold text-6xl ${props.width}`}>
                {props.title}
              </p>
            ...
            <div className="absolute  top-0 left-[50%] m-auto">
              <img src={props.Badge} alt={props.alt} className="" />
            </div>
          </div>
